    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Press",handler: () => {
            ...
            },},{id: "press-laser-trial-run-kickstarts-new-era-of-interferometry",
          title: 'Laser trial run kickstarts new era of interferometry',
          description: "Four lasers were projected into the skies above the European Southern Observatory’s (ESO’s) Paranal site in Chile. The lasers are each used to create an artificial star, which astronomers use to measure and then correct the blur caused by Earth&#39;s atmosphere. The striking launch of these lasers, one from each of the eight-metre telescopes at Paranal, is a significant milestone of the GRAVITY+ project — a large and complex upgrade to ESO’s Very Large Telescope Interferometer (VLTI). GRAVITY+ unlocks a greater observing power and a much wider sky coverage for the VLTI than previously possible.",
          section: "Press",handler: () => {
              window.location.href = "/press/12_press.html";
            },},{id: "press-dancing-on-the-edge-of-a-black-hole-meet-s301",
          title: 'Dancing on the edge of a black hole: Meet S301',
          description: "GRAVITY+ at ESO’s Very Large Telescope Interferometer has discovered S301, a star about two billion times fainter than Betelgeuse on an extreme orbit around Sagittarius A*, the supermassive black hole at the centre of the Milky Way. At closest approach it comes within roughly the Sun–Saturn distance of the black hole and moves at nearly 8% of the speed of light. Its path is sensitive to Lense–Thirring frame-dragging, so further observations may provide the first direct measurement of how fast the Galaxy’s central black hole is spinning. Researchers from the KU Leuven Institute of Astronomy are co-authors of the Nature paper.",
          section: "Press",handler: () => {
              window.location.href = "/press/13_press.html";
